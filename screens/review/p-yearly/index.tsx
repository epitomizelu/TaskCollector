...
const ReviewYearlyScreen = () => {
  const router = useRouter();
  const params = useLocalSearchParams();
  const reviewId = params.reviewId as string;
  const date = params.date as string || reviewService.getDateString('yearly');
  ...
  const initializePage = async () => {
    try {
      ...
      // 检查日期是否变更
      const dateChanged = await reviewService.checkDateChange('yearly');
  ...
  const loadTodayReview = async () => {
    try {
      const today = reviewService.getDateString('yearly');
      const review = await reviewService.getReviewByDate('yearly', today);
      ...
      if (review) {
        ...
        const isToday = reviewService.isToday(date, 'yearly');
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <View style={styles.headerTitleContainer}>
              <Text style={styles.title}>年复盘</Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>本年评分 (1-10)</Text>
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>本年成就</Text>
              <FontAwesome6
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>本年反思</Text>
              <FontAwesome6
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>明年改进</Text>
              <FontAwesome6
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>本年感恩</Text>
              <FontAwesome6
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>明年目标</Text>
              <FontAwesome6
