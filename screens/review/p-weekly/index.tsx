...
const ReviewWeeklyScreen = () => {
  const router = useRouter();
  const params = useLocalSearchParams();
  const reviewId = params.reviewId as string;
  const date = params.date as string || reviewService.getDateString('weekly');
  ...
  const initializePage = async () => {
    try {
      ...
      // 检查日期是否变更
      const dateChanged = await reviewService.checkDateChange('weekly');
  ...
  const loadTodayReview = async () => {
    try {
      const today = reviewService.getDateString('weekly');
      const review = await reviewService.getReviewByDate('weekly', today);
      ...
      if (review) {
        ...
        const isToday = reviewService.isToday(date, 'weekly');
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            ...
            <View style={styles.headerTitleContainer}>
              <Text style={styles.title}>周复盘</Text>
          ...
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>本周评分 (1-10)</Text>
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>本周反思</Text>
              <FontAwesome6
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>下周改进</Text>
              <FontAwesome6
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>本周感恩</Text>
              <FontAwesome6
          ...
          <View style={styles.section}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.sectionTitle}>下周目标</Text>
              <FontAwesome6
